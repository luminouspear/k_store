...
export default function MobileNavbar(props) {
  ...
  console.log("The mobile navbar received: " + menuData)
    ...
    <div className="h-fit lg:hidden" >
      <div className="w-full h-24 flex justify-end items-center space-x-0 align-middle ">
        <div className="flex w-16 h-16 flex-row justify-center items-center space-x-0 group">
          <i className="relative fas fa-shopping-cart h-10 w-10 text-center text-slate-200 text-4xl group-hover:text-kyellow group-hover:shadow-kmag2 scale-[85%]">
        ...
        <div className="flex  w-16 h-16 px-4 justify-center align-center items-center"
          ...
          <i className={(toggleNav ?
            "fas fa-close " : "fas fa-bars ") + " h-10 w-10 text-center text-slate-200 text-4xl  hover:text-kyellow hover:shadow-kmag2 visible"}></i></div>
      </div>
