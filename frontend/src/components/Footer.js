...
const Footer = () => {
  return (
    <footer className="w-full max-w-7xl container mx-auto bg-transparent py-20 ">
      ...
      <div className="flex w-9/12 md:w-8/12 lg:w-8/12 mx-auto justify-between align-middle content-center items-center h-24 ">
        <div className="pb-4">{KStoreTitle("simcoe stitchcraft")}</div>
