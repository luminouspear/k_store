      ...
      <div className="w-full max-w-7xl container mx-auto bg-transparent mt-6 md:mt-12">
        ...
        <div className="mx-12 mt-12 lg:mt-24 grid grid-cols-2 gap-6 gap-y-0 md:gap-12 md:gap-y-0 lg:gap-y-12 lg:grid-cols-3 2xl:gap-12">
          <div className=" mt-12 lg:mt-0 cursor-pointer">
            <div className="aspect-w-4 aspect-h-4 bg-white/50 rounded-3xl isolate shadow-kyellow4 overflow-hidden">
              <img
          ...
          <div className=" mt-12 lg:mt-0 cursor-pointer">
            <div className="aspect-w-4 aspect-h-4 bg-white/50 rounded-3xl isolate shadow-kcyan4 overflow-hidden">
              <img
        ...
        <div className="flex mt-12">
          <button className="w-10/12 md:w-6/12 lg:w-4/12 mb-12 py-4 md:py-6 bg-kcyan rounded-full text-white mx-auto font-quicksand text-2xl lg:text-3xl font-bold shadow-kyellow4 hover:text-kyellow4 ">
            View the Gallery
          </button>
        </div>
      </div>
