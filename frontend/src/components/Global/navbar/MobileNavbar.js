  ...
  return (
    <div className="h-fit lg:hidden" >
      <div className="flex items-center justify-end w-full h-24 align-middle space-x-0 ">
        <div className="flex flex-row items-center justify-center w-16 h-16 space-x-0 group">
          <i className="relative fas fa-shopping-cart h-10 w-10 text-center text-slate-200 text-4xl group-hover:text-kyellow group-hover:drop-shadow-kmag2 scale-[85%]">
            <span className="absolute w-4 h-4 text-xs font-extrabold rounded-full -top-1 -right-2 text-kmag bg-slate-200 group-hover:text-kmag group-hover:shadow-kmag2 group-hover:bg-kyellow
  shadow-kblack2">0
            </span></i>
        </div>
