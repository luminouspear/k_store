  ...
  return (
    ...
    <section className="w-full mx-auto max-w-7xl">
        ...
        <div className="w-full mx-auto lg:px-0 ">
            ...
            <div className=" lg:col-span-full lg:col-start-10 xl:col-start-10  xl:col-span-7 2xl:col-start-9 2xl:col-span-8 lg:row-start-[7] 2xl:row-start-[8]  lg:row-span-3 z-10 lg:-translate-x-0">
              <TextCalloutBox layoutPrefs={"w-auto lg:block md:py-0 lg:py-8 lg:px-4 xl:w-full"}>
           <>
             <h1 className="flex flex-col items-center justify-center align-middle h-fit">
