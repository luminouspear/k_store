  ...
  return (
    ...
    <section class="w-full mx-auto max-w-7xl">
        <div class="w-full mx-auto h-fit">
          ...
          {/* lg:min-h-[730px] lg:max-h-[1024px] xl:h-[900px] 2xl:h-[1000px] */}
        <div class="w-full px-4 lg:px-0 mx-auto
        ">
            <div class="flex flex-col lg:grid lg:grid-flow-row grid-cols-1 lg:grid-cols-[repeat(16,_minmax(0,_1fr))] lg:grid-rows-[repeat(16,_minmax(0,_1fr))] pb-4 lg:pb-0 mx-8">

            <div
              class=" lg:col-start-1 lg:col-span-12 lg:row-span-full row-start-2">
              <HeroImageContainer
                gallery={gallery}
            ...
            <div class=" lg:col-span-full lg:col-start-10 xl:col-start-10  xl:col-span-7 2xl:col-start-9 2xl:col-span-8 lg:row-start-[7] 2xl:row-start-[7]  lg:row-span-3 z-10 lg:-translate-x-0">
              <TextCalloutBox layoutPrefs={"w-auto lg:block"}>
           <>
             <h1 className="lg:mt-12 w-10/12 md:w-8/12 lg:w-10/12 mx-auto font-quicksand text-5xl xl:text-5xl text-center text-white lg:text-kblack font-normal leading-tight xl:leading-[3.6rem] ">
...
//           <div class="w-full h-full aspect-[4/5] md:aspect-square lg:aspect-none lg:col-span-8 xl:col-span-6 lg:col-start-1 xl:col-start-1 lg:row-[span_10_/_span_10] lg:row-start-2">
//         {/* Gallery Container */}
//           {/* Image Container */}
//
